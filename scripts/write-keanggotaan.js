            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex flex-col gap-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-9 pr-4 py-2 border border-outline-variant rounded-lg text-body-sm bg-surface focus:border-primary focus:outline-none text-on-surface min-w-[200px]"
                  />
                </div>
              </div>
              <div className="flex flex-col gap-1">
                ...
                <select
                  ...
                  className="border border-outline-variant rounded-lg bg-surface text-body-sm px-4 py-2 focus:border-primary focus:outline-none min-w-[140px] text-on-surface"
                >
              ...
              <div className="flex flex-col gap-1">
                ...
                <select
                  ...
                  className="border border-outline-variant rounded-lg bg-surface text-body-sm px-4 py-2 focus:border-primary focus:outline-none min-w-[160px] text-on-surface"
                >
...
fs.writeFileSync('/Users/yakinyakin/Coding/dwp/dwp-app/src/app/keanggotaan/page.tsx', content, 'utf8');
console.log('OK - baris:', content.split('\\n').length);
