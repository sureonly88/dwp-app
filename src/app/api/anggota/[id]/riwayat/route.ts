...
export async function GET(
  ...
  try {
    ...
    const [presensiRows] = await pool.execute<RowDataPacket[]>(
    ...
    const [arisanRows] = await pool.execute<RowDataPacket[]>(
    ...
    const [doorprizeRows] = await pool.execute<RowDataPacket[]>(
