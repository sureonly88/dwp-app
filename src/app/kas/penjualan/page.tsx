                 ...
                 data.map((s) => (
                   <tr key={s.id} className="hover:bg-surface-container-low/50 text-body-sm">
                     ...
                     <td className="px-4 py-3">
                       {s.cash_status === "approved" ? <Badge label="Disetujui" variant="success" />
                         : s.cash_status === "pending" ? <Badge label="Menunggu" variant="warning" />
                         : s.cash_status ? <Badge label={s.cash_status} variant="neutral" />
